...
value_df = pd.read_sql_query('select * from segment_attribute_time_value where segment_attribute_id in (14,15,16,17) and attribute_granularity_id = 3;', con=conn2)
...
df_final= final_df.rename(columns={'year':'y', 'month':'m','value_content_consumed_threads_viewed':'total_thread_view','value_content_consumed_searches':'total_searches','value_average_thread_views_per_user':'average_thread_views_per_user','value_average_searches_per_user':'average_searches_per_user'})

df1=pd.merge(df_final, user_df, how='left', left_on='segment_id', right_on='id')
df1 = df1[['date_index', 'y', 'm','segment_id','total_thread_view','total_searches','average_thread_views_per_user','average_searches_per_user' ]]
...
sql1 = '''select segment_id, y, m, date_index,total_thread_view, total_searches, average_thread_views_per_user, average_searches_per_user from audience_content_consumed_searches_trend;'''
...
result_file = 'A360M_audience_content_consumed_searches_trend.xlsx'
