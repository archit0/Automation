...
sql1 = '''select segment_id, y, m, w, dw, date_index,total_thread_view, total_searches, average_thread_views_per_user, average_searches_per_user from audience_monthly_content_consumed_searches_trend;'''
...
result_file = 'A360D_audience_content_consumed_searches_trend.xlsx'
