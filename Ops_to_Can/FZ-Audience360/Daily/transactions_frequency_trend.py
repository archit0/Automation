...
value_df = pd.read_sql_query('select * from segment_attribute_time_value where segment_attribute_id in (1,2,3,4,5,6,9,40) and attribute_granularity_id = 1;', con=conn2)
...
df1['average_transactions_frequency_per_customer']=df1['average_transactions_frequency_per_customer'].astype(float)
df1.sort_values(['segment_id', 'y', 'm', 'w', 'dw', 'date_index'], ascending = True, inplace = True)

sql1 = '''select segment_id, y, m, w, dw, date_index, total_transaction_amount, average_total_transaction_amount_per_customer, transactions_frequency, average_transactions_frequency_per_customer, avg_transaction_amount, total_commission, average_total_commission_per_customer, avg_total_commission from audience_transactions_frequency_trend;'''

df2 = pd.read_sql_query(sql1, con=conn1)
df2.sort_values(['segment_id', 'y', 'm', 'w', 'dw', 'date_index'], ascending = True, inplace = True)
...
result_file = 'A360D_transactions_frequency_trend.xlsx'
