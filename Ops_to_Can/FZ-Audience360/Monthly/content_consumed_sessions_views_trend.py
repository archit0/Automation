...
df_final= final_df.rename(columns={'year':'y', 'month':'m','value_content_consumed_visits':'total_views','value_total_sessions':'total_sessions','value_average_total_sessions':'average_total_sessions','value_average_total_views':'average_total_views'})

df1=pd.merge(df_final, user_df, how='left', left_on='segment_id', right_on='id')
df1 = df1[['date_index', 'y', 'm','segment_id','average_total_views','average_total_sessions','total_sessions','total_views']]
...
sql1 = '''Select segment_id, date_index, y, m, average_total_views, average_total_sessions, total_sessions, total_views from audience_content_consumed_sessions_views_trend'''
