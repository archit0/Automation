...
value_df = pd.read_sql_query('select * from segment_attribute_time_value where segment_attribute_id in (1,2,3,4,5,6,9) and attribute_granularity_id = 3;', con=conn2)
...
df_final= final_df.rename(columns={'year':'y', 'month':'m', 'value_sum_net_transaction_amount':'total_transaction_amount','value_avg_net_transaction_amount':'avg_transaction_amount','value_transactions_frequency':'transactions_frequency','value_sum_net_total_commission':'total_commission','value_avg_net_total_commission':'avg_total_commission','value_average_total_transaction_amount_per_customer':'average_total_transaction_amount_per_customer','value_average_total_commission_per_customer':'average_total_commission_per_customer'})

df1=pd.merge(df_final, user_df, how='left', left_on='segment_id', right_on='id')
df1 = df1[['date_index', 'y', 'm', 'segment_id','total_transaction_amount', 'avg_transaction_amount', 'transactions_frequency', 'total_commission', 'avg_total_commission', 'average_total_transaction_amount_per_customer', 'average_total_commission_per_customer' ]]
...
sql1 = '''select segment_id, y, m, date_index, total_transaction_amount, average_total_transaction_amount_per_customer, transactions_frequency, average_transactions_frequency_per_customer, avg_transaction_amount, total_commission, average_total_commission_per_customer, avg_total_commission from audience_monthly_transactions_frequency_trend;'''
...
result_file = 'A360M_transactions_frequency_trend.xlsx'
