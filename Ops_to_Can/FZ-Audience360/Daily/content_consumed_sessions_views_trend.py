...
value_df = pd.read_sql_query('select * from segment_attribute_time_value where segment_attribute_id in (10,11,12,13) and attribute_granularity_id = 1;', con=conn2)
...
df_final= final_df.rename(columns={'year':'y', 'month':'m', 'week':'w', 'weekday':'dw','value_content_consumed_visits':'total_views','value_total_sessions':'total_sessions','value_average_total_sessions':'average_total_sessions','value_average_total_views':'average_total_views'})

df1=pd.merge(df_final, user_df, how='left', left_on='segment_id', right_on='id')
df1 = df1[['date_index', 'y', 'm', 'w', 'dw','segment_id','average_total_views','average_total_sessions','total_sessions','total_views']]
...
sql1 = '''Select segment_id, date_index, y, m, w, dw, average_total_views, average_total_sessions, total_sessions, total_views from audience_content_consumed_sessions_views_trend'''
...
result_file = 'A360D_content_consumed_sessions_views_trend.xlsx'
