...
df_final= final_df.rename(columns={'customer_id':'user_id', 'year':'y', 'month':'m', 'week':'w', 'weekday':'dw','value_content_consumed_visits':'total_views', 'value_total_sessions':'total_sessions'})

df1=pd.merge(df_final, user_df, how='left', left_on='user_id', right_on='id')
df1 = df1[['date_index', 'y', 'm', 'w', 'dw', 'total_views','total_sessions', 'external_id']]
df1 = df1.rename(columns={'external_id':'user_id'})

sql1 = '''Select user_id, y, m, w, dw, date_index, total_sessions, total_views from content_consumed_sessions_views_trend where datE_index = 20190701 ;'''
...
result_file = 'content_consumed_sessions_views_trend.xlsx'
